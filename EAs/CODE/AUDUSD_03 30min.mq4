...
//|    Generated at Mon Feb 19 04:35:00 GMT 2018
//|                                                          
//|    Tested on AUDUSD, M30, 01.01.2004 - 01.02.2016
...
extern string CustomComment = "AUDUSD_03";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: (RSI(34) Crosses Below 70.239998)
      if(TradeLong) {
         bool LongEntryCondition = ((iRSI(NULL, 0, 34, PRICE_CLOSE, 2) > 70.239998) && (iRSI(NULL, 0, 34, PRICE_CLOSE, 1) < 70.239998));
         if(LongEntryCondition == true) {
            openPosition(1);
         }
      }
   
      // SHORT: (RSI(34) Crosses Above 29.760002)
      if(TradeShort) {
         bool ShortEntryCondition = ((iRSI(NULL, 0, 34, PRICE_CLOSE, 2) < 29.760002) && (iRSI(NULL, 0, 34, PRICE_CLOSE, 1) > 29.760002));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "AUDUSD_03", 9, "Tahoma", LabelColor);
...
double getStopLoss(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT(218 * gPointCoef));
   } else {
      // short
      return(checkCorrectMinMaxSLPT(218 * gPointCoef));
   }
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT(62 * gPointCoef));
   } else {
      // short
      return(checkCorrectMinMaxSLPT(62 * gPointCoef));
   }
