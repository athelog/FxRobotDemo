//+------------------------------------------------------------------+
//| AUDUSD_03_tested_200usd EA
//|
//|    Generated by StrategyQuant version 3.8.1
//|    Generated at Fri Jun 08 01:19:00 GMT 2018
//|
...
extern string CustomComment = "AUDUSD_03_tested_200usd";
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "AUDUSD_03_tested_200usd", 9, "Tahoma", LabelColor);
...
double getStopLoss(int tradeDirection) {
   if(tradeDirection == 1) {
      ...
      // short
      return(checkCorrectMinMaxSLPT(100 * gPointCoef));
   }
