...
extern string CustomComment = "Strategy 6.19";
...
int start() {
   ...
   // ENTRY RULES
      ...
      // LONG: (SMA(57) < EMA(87))
      if(TradeLong) {
         bool LongEntryCondition = (iMA(NULL, 0, 57, 0, MODE_SMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 87, 0, MODE_EMA, PRICE_CLOSE, 1));
      ...
      // SHORT: (SMA(57) > EMA(87))
      if(TradeShort) {
         bool ShortEntryCondition = (iMA(NULL, 0, 57, 0, MODE_SMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 87, 0, MODE_EMA, PRICE_CLOSE, 1));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 6.19", 9, "Tahoma", LabelColor);
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT((4.3 * iATR(NULL, 0, 82, 1))));
   } else {
      // short
      return(checkCorrectMinMaxSLPT((4.3 * iATR(NULL, 0, 82, 1))));
   }
